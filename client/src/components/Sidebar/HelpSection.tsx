...
const helperSections: HelperSection[] = [
  ...
  {
    title: "Ansichten",
    text: "Es gibt 2 Ansichten, die du nutzen kannst. In der Gebietsansicht wird die Karte nach deinen Filtergruppen gefiltert und zeigt Gebiete an, die für dich relevant sind. Bei der Ortsansicht werden dir die verschiedenen Filterobjekte auf der Karte farblich markiert.",
  },
];
